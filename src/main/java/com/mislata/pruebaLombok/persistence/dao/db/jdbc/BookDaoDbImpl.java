...
import com.mislata.pruebaLombok.persistence.dao.db.jdbc.mapper.BookRowMapper;
...
public class BookDaoDbImpl implements BookDaoDb {
    ...
    public Optional<Book> findByIsbn(String isbn) {
        ...
        try {
            ...
            book.setAuthors(authorDaoDb.getByIsbnBook(isbn));
            book.setGenres(genreDaoDb.getByIsbnBook(isbn));
    ...
    public Optional<Book> findById(long id) {
       ...
       """;
        try {
            ...
            book.setAuthors(authorDaoDb.getByIdBook(id));
            book.setGenres(genreDaoDb.getByIdBook(id));
            return Optional.of(book);
        } catch (Exception e) {
            return Optional.empty();
        }
