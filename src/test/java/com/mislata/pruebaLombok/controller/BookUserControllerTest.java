package com.mislata.pruebaLombok.controller;

import com.mislata.pruebaLombok.controller.user.BookUserController;
import com.mislata.pruebaLombok.data.BookTestData;
import com.mislata.pruebaLombok.domain.exception.ResourceNotFoundException;
import com.mislata.pruebaLombok.domain.user.service.BookUserService;
...
class BookUserControllerTest {
    ...
    void testGetAll() throws Exception {
        when(bookUserService.findAll()).thenReturn(BookTestData.getBooks());
